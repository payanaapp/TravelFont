...
payana_profile_picture_upload_storage_object_status = payana_upload_storage_object(
    gcs_payana_profile_pictures_bucket_name, payana_gcs_image_upload_path, profile_picture_bucket_name)
...
payana_profile_picture_set_metadata_gcs_status = payana_set_metadata_gcs_object(
    gcs_payana_profile_pictures_bucket_name, profile_picture_bucket_name, metadata_object)
...
payana_profile_picture_upload_signed_url_content = payana_generate_upload_signed_url(
    gcs_payana_profile_pictures_bucket_name, profile_picture_bucket_name)
...
payana_profile_picture_download_storage_object_status = payana_download_storage_object(
    gcs_payana_profile_pictures_bucket_name, profile_picture_bucket_name, payana_gcs_image_download_path)
...
# upload a blob - Video
payana_profile_picture_upload_storage_object_status = payana_upload_storage_object(
    gcs_payana_profile_pictures_bucket_name, payana_gcs_video_upload_path, profile_video_bucket_name)
...
payana_profile_picture_download_storage_object_status = payana_download_storage_object(
    gcs_payana_profile_pictures_bucket_name, profile_video_bucket_name, payana_gcs_video_download_path)
...
# delete a blob
payana_profile_picture_delete_storage_object_status = payana_delete_storage_object(
    gcs_payana_profile_pictures_bucket_name, profile_video_bucket_name)
