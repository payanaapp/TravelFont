...
class PayanaPersonalPlaceIdRatingItineraryTable:
    ...
    def __init__(self, profile_id, place_id, activity_guide_id,
    ...
    def set_activities_write_object(self):
        ...
        for activity in self.activities:
            if activity in bigtable_constants.payana_activity_column_family:
                ...
                activity_guide_activity_column_family_id = "_".join([activity, self.payana_personal_place_id_itinerary_table_rating_column_family_id,
                                                             bigtable_constants.payana_personal_place_id_itinerary_table_activity_guide_id_quantifier_value])
