...
class PayanaPersonalCountryItineraryTable:
    ...
    def update_personal_country_itinerary_bigtable(self):
        ...
        payana_global_country_itinerary_instance.insert_columns(
            self.update_bigtable_write_objects)
    ...
    def set_generic_activity_write_object(self):
        ...
        itinerary_activity_generic_column_family_id = "_".join(
            [self.activity_generic_column_family_id, bigtable_constants.payana_personal_country_itinerary_table_itinerary_id_quantifier_value])

        excursion_activity_generic_column_family_id = "_".join(
            [self.activity_generic_column_family_id, bigtable_constants.payana_personal_country_itinerary_table_excursion_id_quantifier_value])

        checkin_activity_generic_column_family_id = "_".join(
            [self.activity_generic_column_family_id, bigtable_constants.payana_personal_country_itinerary_table_checkin_id_quantifier_value])
        ...
        for activity in self.activities:
            if activity in bigtable_constants.payana_activity_column_family:
                ...
                itinerary_activity_column_family_id = "_".join(
                    [activity, bigtable_constants.payana_personal_country_itinerary_table_itinerary_id_quantifier_value])

                excursion_activity_column_family_id = "_".join(
                    [activity, bigtable_constants.payana_personal_country_itinerary_table_excursion_id_quantifier_value])

                checkin_activity_column_family_id = "_".join(
                    [activity, bigtable_constants.payana_personal_country_itinerary_table_checkin_id_quantifier_value])
