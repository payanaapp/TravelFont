...
class PayanaProfileTable:
    ...
    def __init__(self, personal_information, favorite_places_preference, favorite_activities_preference, thumbnail_travel_buddies, top_activities_tracker_rating):
