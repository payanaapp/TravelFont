        ...
        for activity in self.activities:
            if activity in bigtable_constants.payana_activity_column_family:
                ...
                activity_guide_activity_column_family_id = "_".join(
                    [activity, self.payana_global_place_id_itinerary_table_itinerary_id_rating_quantifier_value, bigtable_constants.payana_global_place_id_itinerary_table_activity_guide_id_quantifier_value])
