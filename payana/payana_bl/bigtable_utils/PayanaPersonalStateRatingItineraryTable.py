...
class PayanaPersonalStateRatingItineraryTable:
    ...
    def __init__(self, profile_id, state, activity_guide_id,
        ...
        self.payana_personal_state_itinerary_table_rating_column_family_id = bigtable_constants.payana_personal_state_itinerary_table_rating_column_family_id
        ...
        for activity in self.activities:
            if activity in bigtable_constants.payana_activity_column_family:
                ...
                itinerary_activity_column_family_id = "_".join(
                    [activity, self.payana_personal_state_itinerary_table_rating_column_family_id, bigtable_constants.payana_personal_state_itinerary_table_itinerary_id_quantifier_value])

                excursion_activity_column_family_id = "_".join(
                    [activity, self.payana_personal_state_itinerary_table_rating_column_family_id, bigtable_constants.payana_personal_state_itinerary_table_excursion_id_quantifier_value])
