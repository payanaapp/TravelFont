        ...
        for activity in self.activities:
            if activity in bigtable_constants.payana_activity_column_family:
                ...
                activity_guide_activity_column_family_id = "_".join(
                    [activity, self.payana_personal_country_itinerary_table_rating_column_family_id, bigtable_constants.payana_personal_country_itinerary_table_activity_guide_id_quantifier_value])
