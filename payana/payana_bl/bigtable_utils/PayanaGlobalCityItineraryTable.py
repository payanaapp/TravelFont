...
class PayanaGlobalCityItineraryTable:
    ...
    def update_global_city_itinerary_bigtable(self):
        ...
        payana_global_city_itinerary_instance.insert_columns(
            self.update_bigtable_write_objects)
    ...
    def set_generic_activity_write_object(self):
        ...
        itinerary_activity_generic_column_family_id = self.activity_generic_column_family_id + "_" + bigtable_constants.payana_global_city_itinerary_table_itinerary_id_quantifier_value

        excursion_activity_generic_column_family_id = self.activity_generic_column_family_id + "_" + bigtable_constants.payana_global_city_itinerary_table_excursion_id_quantifier_value

        checkin_activity_generic_column_family_id = self.activity_generic_column_family_id + "_" + bigtable_constants.payana_global_city_itinerary_table_checkin_id_quantifier_value
    ...
    def set_activities_write_object(self):
        ...
        for activity in self.activities:
            if activity in bigtable_constants.payana_activity_column_family:
                ...
                itinerary_activity_column_family_id = activity + "_" + bigtable_constants.payana_global_city_itinerary_table_itinerary_id_quantifier_value

                excursion_activity_column_family_id = activity + "_" + bigtable_constants.payana_global_city_itinerary_table_excursion_id_quantifier_value

                checkin_activity_column_family_id = activity + "_" + bigtable_constants.payana_global_city_itinerary_table_checkin_id_quantifier_value
