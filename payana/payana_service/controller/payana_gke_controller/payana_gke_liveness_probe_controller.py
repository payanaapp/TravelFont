...
payana_gke_health_liveness_name_space = Namespace(
    'live', description='GKE liveness probe')
...
payana_liveness_probe_success_message = payana_service_constants.payana_liveness_probe_success_message
...
@payana_gke_health_liveness_name_space.route("/")
class PayanaGKELivenessEndPoint(Resource):

    @payana_gke_health_liveness_name_space.doc(responses={200: payana_200_response, 400: payana_400_response, 500: payana_500_response})
    @payana_service_generic_exception_handler
    def get(self):

        return {
            status: payana_200_response,
            message: payana_liveness_probe_success_message,
