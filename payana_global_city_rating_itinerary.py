...
payana_global_city_itinerary_table_itinerary_id_rating_quantifier_value = bigtable_constants.payana_global_city_itinerary_table_itinerary_id_rating_quantifier_value

payana_global_city_itinerary_obj = PayanaGlobalCityRatingItineraryTable(
    **global_city_itinerary_obj)
...
itinerary_activity_generic_column_family_id = "_".join(
    [activity_generic_column_family_id, payana_global_city_itinerary_table_itinerary_id_rating_quantifier_value, bigtable_constants.payana_global_city_itinerary_table_itinerary_id_quantifier_value])

excursion_activity_generic_column_family_id = "_".join(
    [activity_generic_column_family_id, payana_global_city_itinerary_table_itinerary_id_rating_quantifier_value, bigtable_constants.payana_global_city_itinerary_table_excursion_id_quantifier_value])

checkin_activity_generic_column_family_id = "_".join(
    [activity_generic_column_family_id, payana_global_city_itinerary_table_itinerary_id_rating_quantifier_value, bigtable_constants.payana_global_city_itinerary_table_checkin_id_quantifier_value])
...
for rating, checkin_id in checkin_new.items():
    ...
    payana_global_city_checkin_read_row_obj = payana_global_city_itinerary_read_obj.get_row_dict(
        row_id, include_column_family=True)
    updated_checkin_id = payana_global_city_checkin_read_row_obj[row_id][
...
for rating, itinerary_id in itinerary_update.items():
    for activity in activity_update:
        itinerary_activity_column_family_id = "_".join(
            [activity, payana_global_city_itinerary_table_itinerary_id_rating_quantifier_value, bigtable_constants.payana_global_city_itinerary_table_itinerary_id_quantifier_value])

        excursion_activity_column_family_id = "_".join(
            [activity, payana_global_city_itinerary_table_itinerary_id_rating_quantifier_value, bigtable_constants.payana_global_city_itinerary_table_excursion_id_quantifier_value])

        checkin_activity_column_family_id = "_".join(
            [activity, payana_global_city_itinerary_table_itinerary_id_rating_quantifier_value, bigtable_constants.payana_global_city_itinerary_table_checkin_id_quantifier_value])
...
for rating, checkin_id in checkin_update.items():
    for activity in activity_update:
        ...
        payana_global_city_checkin_read_row_obj = payana_global_city_itinerary_read_obj.get_row_dict(
            row_id, include_column_family=True)
        updated_checkin_id = payana_global_city_checkin_read_row_obj[
