...
from payana.payana_bl.bigtable_utils.PayanaGlobalCountryRatingItineraryTable import PayanaGlobalCountryRatingItineraryTable
...
payana_global_country_itinerary_table_itinerary_id_rating_quantifier_value = bigtable_constants.payana_global_country_itinerary_table_itinerary_id_rating_quantifier_value

payana_global_country_itinerary_obj = PayanaGlobalCountryRatingItineraryTable(
    **global_country_itinerary_obj)
...
itinerary_activity_generic_column_family_id = "_".join(
    [activity_generic_column_family_id, payana_global_country_itinerary_table_itinerary_id_rating_quantifier_value, bigtable_constants.payana_global_country_itinerary_table_itinerary_id_quantifier_value])

excursion_activity_generic_column_family_id = "_".join(
    [activity_generic_column_family_id, payana_global_country_itinerary_table_itinerary_id_rating_quantifier_value, bigtable_constants.payana_global_country_itinerary_table_excursion_id_quantifier_value])

checkin_activity_generic_column_family_id = "_".join(
    [activity_generic_column_family_id, payana_global_country_itinerary_table_itinerary_id_rating_quantifier_value, bigtable_constants.payana_global_country_itinerary_table_checkin_id_quantifier_value])
...
for rating, itinerary_id in itinerary_update.items():
    for activity in activity_update:
        itinerary_activity_column_family_id = "_".join(
            [activity, payana_global_country_itinerary_table_itinerary_id_rating_quantifier_value, bigtable_constants.payana_global_country_itinerary_table_itinerary_id_quantifier_value])

        excursion_activity_column_family_id = "_".join(
            [activity, payana_global_country_itinerary_table_itinerary_id_rating_quantifier_value, bigtable_constants.payana_global_country_itinerary_table_excursion_id_quantifier_value])

        checkin_activity_column_family_id = "_".join(
            [activity, payana_global_country_itinerary_table_itinerary_id_rating_quantifier_value, bigtable_constants.payana_global_country_itinerary_table_checkin_id_quantifier_value])
