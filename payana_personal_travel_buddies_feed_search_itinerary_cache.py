...
from payana.payana_bl.bigtable_utils.PayanaPersonalTravelBuddyFeedSearchItineraryCache import PayanaPersonalTravelBuddyFeedSearchItineraryCache
...
payana_feed_search_itinerary_cache_obj = PayanaPersonalTravelBuddyFeedSearchItineraryCache(
    **feed_search_itinerary_cache_obj)
...
payana_personal_travel_buddy_feed_search_itinerary_cache_table = bigtable_constants.payana_personal_travel_buddy_feed_search_itinerary_cache_table
...
payana_feed_search_itinerary_cache_read_obj = PayanaBigTable(
    payana_personal_travel_buddy_feed_search_itinerary_cache_table)
