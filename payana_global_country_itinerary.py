...
itinerary_activity_generic_column_family_id = "_".join([activity_generic_column_family_id, bigtable_constants.payana_global_country_itinerary_table_itinerary_id_quantifier_value])

excursion_activity_generic_column_family_id = "_".join([activity_generic_column_family_id, bigtable_constants.payana_global_country_itinerary_table_excursion_id_quantifier_value])

checkin_activity_generic_column_family_id = "_".join([activity_generic_column_family_id, bigtable_constants.payana_global_country_itinerary_table_checkin_id_quantifier_value])
...
for itinerary_id, rating in itinerary_new.items():
    payana_global_country_itinerary_table_write_object = bigtable_write_object_wrapper(row_id, itinerary_activity_generic_column_family_id, itinerary_id, rating)
    payana_global_country_itinerary_read_obj.insert_column(payana_global_country_itinerary_table_write_object)
    payana_global_country_itinerary_read_row_obj = payana_global_country_itinerary_read_obj.get_row_dict(row_id, include_column_family=True)
    updated_rating = payana_global_country_itinerary_read_row_obj[row_id][itinerary_activity_generic_column_family_id][itinerary_id]

    print("Status of itinerary ID update: " + str(rating == updated_rating))
    
for excursion_id, rating in excursion_new.items():
    payana_global_country_excursion_table_write_object = bigtable_write_object_wrapper(row_id, excursion_activity_generic_column_family_id, excursion_id, rating)
    payana_global_country_itinerary_read_obj.insert_column(payana_global_country_excursion_table_write_object)
    payana_global_country_excursion_read_row_obj = payana_global_country_itinerary_read_obj.get_row_dict(row_id, include_column_family=True)
    updated_rating = payana_global_country_excursion_read_row_obj[row_id][excursion_activity_generic_column_family_id][excursion_id]

    print("Status of excursion ID update: " + str(rating == updated_rating))
    
for checkin_id, rating in checkin_new.items():
    payana_global_country_checkin_table_write_object = bigtable_write_object_wrapper(row_id, checkin_activity_generic_column_family_id, checkin_id, rating)
    ...
    updated_rating = payana_global_country_checkin_read_row_obj[row_id][checkin_activity_generic_column_family_id][checkin_id]
...
itinerary_update = global_country_itinerary_update_obj[payana_global_country_itinerary_table_itinerary_id_quantifier_value]
excursion_update =  global_country_itinerary_update_obj[payana_global_country_itinerary_table_excursion_id_quantifier_value]
checkin_update = global_country_itinerary_update_obj[payana_global_country_itinerary_table_checkin_id_quantifier_value]
activity_update = global_country_itinerary_update_obj[bigtable_constants.payana_global_country_itinerary_table_activities]

for itinerary_id, rating in itinerary_update.items():
    for activity in activity_update:
        itinerary_activity_column_family_id =  "_".join([activity, bigtable_constants.payana_global_country_itinerary_table_itinerary_id_quantifier_value])

        excursion_activity_column_family_id = "_".join([activity, bigtable_constants.payana_global_country_itinerary_table_excursion_id_quantifier_value])
        ...
        payana_global_country_itinerary_table_write_object = bigtable_write_object_wrapper(row_id, itinerary_activity_column_family_id, itinerary_id, rating)
        payana_global_country_itinerary_read_obj.insert_column(payana_global_country_itinerary_table_write_object)
        payana_global_country_itinerary_read_row_obj = payana_global_country_itinerary_read_obj.get_row_dict(row_id, include_column_family=True)
        updated_rating = payana_global_country_itinerary_read_row_obj[row_id][itinerary_activity_column_family_id][itinerary_id]
...
for excursion_id, rating in excursion_update.items():
    for activity in activity_update:
        ...
        payana_global_country_excursion_table_write_object = bigtable_write_object_wrapper(row_id, excursion_activity_column_family_id, excursion_id, rating)
        payana_global_country_itinerary_read_obj.insert_column(payana_global_country_excursion_table_write_object)
        payana_global_country_excursion_read_row_obj = payana_global_country_itinerary_read_obj.get_row_dict(row_id, include_column_family=True)
        updated_rating = payana_global_country_excursion_read_row_obj[row_id][excursion_activity_column_family_id][excursion_id]
...
for checkin_id, rating in checkin_update.items():
    for activity in activity_update:
        ...
        payana_global_country_checkin_table_write_object = bigtable_write_object_wrapper(row_id, checkin_activity_column_family_id, checkin_id, rating)
        payana_global_country_itinerary_read_obj.insert_column(payana_global_country_checkin_table_write_object)
        payana_global_country_checkin_read_row_obj = payana_global_country_itinerary_read_obj.get_row_dict(row_id, include_column_family=True)
        updated_rating = payana_global_country_checkin_read_row_obj[row_id][checkin_activity_column_family_id][checkin_id]

        print("Status of checkin ID activity update: " + str(rating == updated_rating))

#Remove an itinerary ID, excursion ID, check ID
for itinerary_id, rating in itinerary_new.items():
    payana_global_country_itinerary_table_write_object = bigtable_write_object_wrapper(row_id, itinerary_activity_generic_column_family_id, itinerary_id, "")
...
for excursion_id, rating in excursion_new.items():
    payana_global_country_excursion_table_write_object = bigtable_write_object_wrapper(row_id, excursion_activity_generic_column_family_id, excursion_id, "")
    payana_global_country_itinerary_read_obj.delete_bigtable_row_column(payana_global_country_excursion_table_write_object)
    payana_global_country_excursion_read_row_obj = payana_global_country_itinerary_read_obj.get_row_dict(row_id, include_column_family=True)
    removed_excursion_row = payana_global_country_excursion_read_row_obj[row_id][excursion_activity_generic_column_family_id]

    print("Status of excursion ID remove: " + str(excursion_id not in removed_excursion_row))
    
for checkin_id, rating in checkin_new.items():
    payana_global_country_checkin_table_write_object = bigtable_write_object_wrapper(row_id, checkin_activity_generic_column_family_id, checkin_id, "")
    payana_global_country_itinerary_read_obj.delete_bigtable_row_column(payana_global_country_checkin_table_write_object)
    payana_global_country_checkin_read_row_obj = payana_global_country_itinerary_read_obj.get_row_dict(row_id, include_column_family=True)
    removed_checkin_row = payana_global_country_checkin_read_row_obj[row_id][checkin_activity_generic_column_family_id]
...
for itinerary_id, rating in itinerary_update.items():
    for activity in activity_update:
        ...
        payana_global_country_itinerary_table_write_object = bigtable_write_object_wrapper(row_id, itinerary_activity_column_family_id, itinerary_id, "")
        payana_global_country_itinerary_read_obj.delete_bigtable_row_column(payana_global_country_itinerary_table_write_object)
        payana_global_country_itinerary_read_row_obj = payana_global_country_itinerary_read_obj.get_row_dict(row_id, include_column_family=True)
        removed_itinerary_row = payana_global_country_itinerary_read_row_obj[row_id][itinerary_activity_column_family_id]
...
for excursion_id, rating in excursion_update.items():
    for activity in activity_update:
        ...
        payana_global_country_excursion_table_write_object = bigtable_write_object_wrapper(row_id, excursion_activity_column_family_id, excursion_id, "")
        payana_global_country_itinerary_read_obj.delete_bigtable_row_column(payana_global_country_excursion_table_write_object)
        payana_global_country_excursion_read_row_obj = payana_global_country_itinerary_read_obj.get_row_dict(row_id, include_column_family=True)
        removed_excursion_row = payana_global_country_excursion_read_row_obj[row_id][excursion_activity_column_family_id]
